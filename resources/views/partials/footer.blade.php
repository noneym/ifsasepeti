<footer class="border-t border-ifsa-border bg-white mt-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 grid grid-cols-1 md:grid-cols-4 gap-6 text-sm">
        <div class="md:col-span-2">
            ...
            <p class="text-ifsa-muted leading-relaxed">
        ...
        <div>
            <h4 class="font-semibold mb-3 uppercase text-xs tracking-wider text-ifsa-ink">Keşfet</h4>
            <ul class="space-y-2 text-ifsa-muted">
        ...
        <div>
            <h4 class="font-semibold mb-3 uppercase text-xs tracking-wider text-ifsa-ink">Site</h4>
            <ul class="space-y-2 text-ifsa-muted">
